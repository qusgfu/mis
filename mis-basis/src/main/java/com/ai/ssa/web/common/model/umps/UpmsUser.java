...
public class UpmsUser implements Serializable {
  ...
  public Integer getPwdDays() {
    return pwdDays;
  }

  public void setPwdDays(Integer pwdDays) {
    this.pwdDays = pwdDays;
  }
...
@Override
  ...
  public boolean equals(Object that) {
    ...
    return (this.getUserId() == null ? other.getUserId() == null
        ...
        && (this.getLocked() == null ? other.getLocked() == null
            : this.getLocked().equals(other.getLocked()))
